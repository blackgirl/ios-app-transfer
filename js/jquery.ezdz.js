  ...
  // console.log(CopyToClipboard('hello world', true));
                    ...
                    setTimeout(function() {
                        ...
                        if (valid === true) {
                            ...
                            if (isImage && settings.previewImage === true) {
                                ...
                                // $ezdz.find('div').html('<span onclick="console.log(CopyToClipboard('+formatted+', true))">' + formatted + '</span>');
                                $('#Uploaded').modal('show');
                                $ezdz.parent().find('#Uploaded').find('b').html('<span >' + formatted + '</span>').on('click',function(){
                                    console.log(CopyToClipboard(formatted, true));
                                });
                            }
    ...
    $.ezdz.prototype.preview = function(path, callback) {
        ...
        img.onerror = function() {
            $ezdz.find('div').html('<span id="baseURI">' + img.src + '</span>');
